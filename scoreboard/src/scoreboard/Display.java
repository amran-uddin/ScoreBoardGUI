...
public class Display {
	...
	private void initialize() {
		...
		team2Label.setFont(new Font("Tahoma", Font.PLAIN, 85));
		...
		team1Label.setFont(new Font("Tahoma", Font.PLAIN, 85));
		team1Label.setForeground(Color.WHITE);
		springLayout.putConstraint(SpringLayout.NORTH, team1Label, 35, SpringLayout.NORTH, team2Label);
		...
		team1Score.setFont(new Font("Tahoma", Font.PLAIN, 150));
		...
		team2Score.setFont(new Font("Tahoma", Font.PLAIN, 150));
		...
		timeLabel.setFont(new Font("Tahoma", Font.PLAIN, 175));
		...
		shotClockLabel.setFont(new Font("Tahoma", Font.PLAIN, 135));
		...
		team1TO.setFont(new Font("Tahoma", Font.PLAIN, 85));
		...
		team2TO.setFont(new Font("Tahoma", Font.PLAIN, 85));
		...
		lblNewLabel_8.setFont(new Font("Tahoma", Font.PLAIN, 45));
		...
		lblNewLabel_9.setFont(new Font("Tahoma", Font.PLAIN, 45));
